...
//Code Here
let myFirstVehicle = new Vehicle(5, "silver", 2000000)
...
//Code Here 
let myMotorcycle = new Motorcycle(1, "black", 0, "Triumph", true)
/*
  Call the move function on myFirstMotorcycle (don't forget the parameter)
*/
myMotorcycle.move(100)
...
//Code Here
let myFirstBoat = new Boat(8, "Dark Gray", 90, "Madi", "Speed Boat", false)
